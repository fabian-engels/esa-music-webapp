...
public class LoginBean implements Serializable {
   ...
   @EJB(mappedName="UserAuth",
        lookup="corbaname:iiop:192.168.1.120:3700#java:global/EsaUserAuth-2.0-SNAPSHOT/UserAuthImpl!de.esa.user.auth.domain.UserAuth",
        beanInterface=UserAuth.class)
    UserAuth userAuth;
